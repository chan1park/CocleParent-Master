...
import kr.cocle.cocleparent.common.DeviceInfo;
...
public class SecurePreferences implements SharedPreferences {
    ...
    */
    ...
    private static final String TAG = com.securepreferences.SecurePreferences.class.getName();
    ...
    private SecurePreferences(Context context, final AesCbcWithIntegrity.SecretKeys secretKey, String password, final String sharedPrefFilename) {
        ...
        //에러 체크
        try {
            String deviceSerialNum = getDeviceSerialNumber(context);
            //base64 디코딩 실패하는경우.
            Base64.decode(deviceSerialNum, AesCbcWithIntegrity.BASE64_FLAGS);
        } catch (Exception e) {
            //password 없이 생성
            password = "";
        }
     ...
     * @param context
     */
    private void generateGeneralKey(Context context) {
        try {
    ...
    private static String generateAesKeyName(Context context) throws GeneralSecurityException {
        final String password = context.getPackageName().replace(".", "").replace("_", "").replace("=", "");
        final byte[] salt = DeviceInfo.getUDID(context).replace(".", "").replace("_", "").replace("=", "").getBytes();
    ...
    private static String getDeviceSerialNumber(Context context) {
        ...
        try {
            ...
            LogUtil.d(TAG, "deviceSerial  SERIAL : " + deviceSerial);
            ...
            if (TextUtils.isEmpty(deviceSerial)) {
                ...
                LogUtil.d(TAG, "deviceSerial  ANDROID_ID : " + deviceSerial);
            } else {
              /*  byte[] byteStr = deviceSerial.getBytes();
                LogUtil.d(TAG, "deviceSerial byte : " + byteStr.toString());
                LogUtil.d(TAG, "deviceSerial byteStr.length  : " + byteStr.length);
                LogUtil.d(TAG, "deviceSerial byteStr.length  3/4 : " + (byteStr.length * 3 / 4));
                if (!Character.isDigit(deviceSerial.charAt(0))) {
                    //deviceSerial = "1" + deviceSerial.toLowerCase();
                    LogUtil.d(TAG, "deviceSerial  Change  SERIAL : " + deviceSerial);
                }*/
            }
            ...
            deviceSerial = Settings.Secure.getString(context.getContentResolver(),
                    Settings.Secure.ANDROID_ID);
            LogUtil.d(TAG, "deviceSerial Exception ANDROID_ID : " + deviceSerial);
        }
    ...
    public String getString(String key, String defaultValue) {
        final String encryptedValue = sharedPreferences.getString(
                com.securepreferences.SecurePreferences.hashPrefKey(key), null);
    ...
    public boolean contains(String key) {
        return sharedPreferences.contains(com.securepreferences.SecurePreferences.hashPrefKey(key));
    }


    /**
     * Cycle through the unencrypt all the current prefs to mem cache, clearFcmInfo, then encypt with key generated from new password.
     ...
     * @param newPassword
     */
    public void handlePasswordChange(String newPassword, Context context) throws
        ...
        //destroy and clearFcmInfo the current pref file
        destroyKeys();
     ...
     * <p/>
     * Used for modifying values in a {@link com.securepreferences.SecurePreferences} object. All
     * changes you make in an editor are batched, and not copied back to the
     * original {@link com.securepreferences.SecurePreferences} until you call {@link #commit()} or
     * {@link #apply()}.
     */
    public class Editor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putString(String key, String value) {
            mEditor.putString(com.securepreferences.SecurePreferences.hashPrefKey(key),
                    encrypt(value));
            return this;
        }
        ...
        public SharedPreferences.Editor putUnencryptedString(String key,
                                                             String value) {
            mEditor.putString(com.securepreferences.SecurePreferences.hashPrefKey(key), value);
            return this;
        }
        ...
        public SharedPreferences.Editor putStringSet(String key,
            ...
            mEditor.putStringSet(com.securepreferences.SecurePreferences.hashPrefKey(key),
                    encryptedValues);
            return this;
        }
        ...
        public SharedPreferences.Editor remove(String key) {
            mEditor.remove(com.securepreferences.SecurePreferences.hashPrefKey(key));
            return this;
        }
